...
var BtcLocalSigner = (function () {
    function BtcLocalSigner(network) {
        var _this = this;
        this.signTransaction = function (transaction, params) { return __awaiter(_this, void 0, void 0, function () {
            var txb, utxos, compressed, private_key, network_, keyPair, ip, tx;
            return __generator(this, function (_a) {
                txb = transaction_1.process_unsignedTx(transaction, this.network);
                utxos = transaction.utxos;
                compressed = params.compressed, private_key = params.private_key;
                network_ = network_1.networks[this.network];
                keyPair = bitcoinjs_lib_1.ECPair.fromPrivateKey(Buffer.from(makkii_utils_1.hexutil.removeLeadingZeroX(private_key), "hex"), {
                    network: network_,
