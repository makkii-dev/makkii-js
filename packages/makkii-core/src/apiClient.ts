...
export default class ApiClient implements IApiClient {
    ...
    getAccountTokenTransferHistory = (
        ...
        const coin = this.getCoin(coinType);
        if ("tokenSupport" in coin && !!coin.tokenSupport) {
            return coin.getAccountTokenTransferHistory(
                address,
                symbolAddress,
                page,
                size,
        ...
        throw new Error(
            `[${coinType}] getAccountTokenTransferHistory is not implemented.`
        );
    };
    ...
    getAccountTokenBalance = (
        ...
        throw new Error(
            `[${coinType}] getAccountTokenBalance is not implemented.`
        );
    };
