...
var lib_hw_ledger_js_1 = require("lib-hw-ledger-js");
var wallet = {};
var isConnect = false;
...
var signByLedger = function (index, sender, msg) {
    ...
    return new Promise(function (resolve, reject) {
        try {
            wallet.getAccount(parseInt(index)).then(function (account) {
                if (account.address !== sender) {
                    reject(new Error('error.wrong_device'));
                }
                wallet.sign(parseInt(index), msg).then(function (res) {
...
var getKeyByLedger = function (index) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, wallet.getAccount(index)];
            case 1:
