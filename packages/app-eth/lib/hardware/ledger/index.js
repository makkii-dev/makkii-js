...
var EthLedger = (function () {
    function EthLedger() {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, this.hardware.getAddress(path, false)];
                    case 1:
        ...
        this.signTransaction = function (transaction, params) { return __awaiter(_this, void 0, void 0, function () {
            var unsigned, derivationIndex, path, res, sig, validSig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        unsigned = transaction_1.process_unsignedTx(transaction);
                        derivationIndex = params.derivationIndex;
                        path = "44'/60'/0'/0/" + derivationIndex;
                        return [4, this.hardware.signTransaction(path, unsigned.serialize().toString("hex"))];
                    case 1:
                        res = _a.sent();
                        sig = {};
                        ...
                        validSig = unsigned.verifySignature();
                        if (!validSig) {
                            throw new Error("sign error: invalid signature");
                        }
                        return [2, "0x" + unsigned.serialize().toString("hex")];
                }
            });
        }); };
        this.setLedgerTransport = function (transport) {
            _this.hardware = new hw_app_eth_1["default"](transport);
            return _this;
        };
    }
    return EthLedger;
