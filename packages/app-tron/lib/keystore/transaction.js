...
const transactionBuilder_1 = require("@tronscan/client/src/utils/transactionBuilder");
const crypto_1 = require("@tronscan/client/src/utils/crypto");
...
exports.signTransaction = (transaction) => new Promise((resolve, reject) => {
    try {
        ...
        const tx = transactionBuilder_1.buildTransferTransaction('_', owner_address, to_address, amount);
        ...
        const signed = crypto_1.signTransaction(lib_common_util_js_1.hexutil.removeLeadingZeroX(private_key), tx);
